...
<body>
    ...
    <div class="auth-container">
      ...
      <!-- Sign In Form -->
      <form id="signin-form" class="auth-form active" method="post" action="/auth/login" onsubmit="handleSignIn(event)">
      ...
      <!-- Sign Up Form -->
      <form id="signup-form" class="auth-form" method="post" action="/auth/signup" onsubmit="handleSignUp(event)">
                        <div class="form-group">
    ...
    <script>
      ...
      // Attach event listeners to OAuth buttons (CSP compliant)

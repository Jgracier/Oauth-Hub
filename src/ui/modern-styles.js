...
export const MODERN_ICONS = {
  ...
  settings: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M12 1v6m0 6v6m4.22-10.22l1.42 1.42m-1.42 7.58l1.42 1.42M20 12h-6m-6 0H2m4.22-7.78L4.8 5.64m1.42 7.58L4.8 18.36"></path></svg>`,
